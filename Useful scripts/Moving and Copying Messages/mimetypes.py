...
'.es':		'application/ecmascript',				#ECMAScript (IANA Specification) (RFC 4329 Section 8.2)
...
'.mpkg':	('application/vnd.apple.'
			'installer+xml'),						#Apple Installer Package	
'.odp':		('application/vnd.oasis.'
			'opendocument.presentation'),			#OpenDocument presentation document
'.ods':		('application/vnd.oasis.'
			'opendocument.spreadsheet'),			#OpenDocument spreadsheet document
'.odt':		('application/vnd.oasis.'
			'opendocument.text'),					#OpenDocument text document
...
'.pptx':	('application/vnd.openxmlformats-'
			...
			'presentation'),						#Microsoft PowerPoint (OpenXML)
...
'.xlsx':	('application/vnd.openxmlformats-'
			'officedocument.spreadsheetml.sheet'),	#Microsoft Excel (OpenXML)	
